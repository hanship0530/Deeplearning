...
from keras.layers import Input, Dense, Flatten, Activation, BatchNormalization, Add, Dropout
...
input_data = Input(name='input', shape=(45,45,3))
conv1 = Conv2D(8, (3,3), padding='same',
            activation='relu', name='CONV2D_1')(input_data)
conv1_b = BatchNormalization()(conv1)
conv2 = Conv2D(8, (3,3), padding='same',
            activation='relu', name='CONV2D_2')(conv1_b)
conv2_b = BatchNormalization()(conv2)
conv3 = Conv2D(8, (3,3), padding='same',
            activation='relu', name='CONV2D_3')(conv2_b)
conv3_b = BatchNormalization()(conv3)
conv4 = Conv2D(8, (3,3), padding='same',
            activation='relu', name='CONV2D_4')(conv3_b)
conv4_b = BatchNormalization()(conv4)
fx_x = Add()([conv1,conv4_b])
...
dense1_b = BatchNormalization()(dense1)
dense2 = Dense(500, activation='relu',
            name='DENSE_2')(dense1_b)
y_pred = Dense(45, activation='softmax',
            name='DENSE_3')(dense2)
